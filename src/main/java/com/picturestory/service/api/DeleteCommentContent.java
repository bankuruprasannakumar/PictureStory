 ...
 */
@Path("/deleteCommentOnContent")
@Produces("application/json")
@Consumes("application/json")
public class DeleteCommentContent {
    private final IUserDetailsDao mUserDetailsDao;
    private final IContentUserCommentDao mContentUserCommentDao;
    private final IContentDetailsDao mContentDetailsDao;
    @Inject
    public DeleteCommentContent(IUserDetailsDao userDetailsDao, IContentUserCommentDao contentUserCommentDao, IContentDetailsDao contentDetailsDao) {
