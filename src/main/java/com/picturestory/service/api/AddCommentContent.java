 ...
 */
@Path("/addCommentOnContent")
@Produces("application/json")
@Consumes("application/json")
public class AddCommentContent {
    private final IUserDetailsDao mUserDetailsDao;
    private final IContentUserCommentDao mContentUserCommentDao;
    private final IContentDetailsDao mContentDetailsDao;

    @Inject
    public AddCommentContent(IUserDetailsDao userDetailsDao, IContentUserCommentDao contentUserCommentDao, IContentDetailsDao contentDetailsDao) {
